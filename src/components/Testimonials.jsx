...
const Testimonials = () => {
  return (
    <section id="testimonials" className="bg-black text-cream py-24 md:py-32 relative">
      {/* Decorative lines */}
      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        <h2 className="text-burgundy uppercase tracking-[0.2em] text-sm font-semibold mb-16">Voices</h2>
